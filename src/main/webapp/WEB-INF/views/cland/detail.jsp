...
<div class="clearfix content">
	...
	<div class="clearfix post-meta">
		<p>
			<span><i class="fa fa-clock-o"></i> Địa chỉ: Phạm Như Xương -
				Đà Nẵng</span> <span><i class="fa fa-folder"></i> Diện tích: 100m2</span>
		</p>
	</div>
	...
	<div class="vnecontent">
		<p>Morbi accumsan ipsum velit. Nam nec tellus a odio tincidunt
			...
			nostra, per inceptos Sed non mauris vitae erat consequat auctor eu in
			elit. Class aptent taciti sociosqu</p>
		<p>Morbi accumsan ipsum velit. Nam nec tellus a odio tincidunt
			auctor a ornare odio. Sed non mauris vitae erat consequat auctor eu
			in elit. Class aptent taciti sociosqu ad litora torquent per conubia
			nostra, per inceptos Sed non mauris vitae erat consequat auctor eu in
