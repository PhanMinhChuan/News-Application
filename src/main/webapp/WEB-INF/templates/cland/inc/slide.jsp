...
<div class="clearfix slider">
	<ul class="pgwSlider">
		<li><img src="${pageContext.request.contextPath}/resources/cland/images/thumbs/megamind_07.jpg" alt="Paris, France"
		...
		<li><img src="${pageContext.request.contextPath}/resources/cland/images/thumbs/wall-e.jpg"
			alt="Montréal, QC, Canada" data-large-src="images/slides/wall-e.jpg"
			data-description="Eiffel Tower and Champ de Mars" /></li>
		<li><img src="${pageContext.request.contextPath}/resources/cland/images/thumbs/up-official-trailer-fake.jpg"
			alt="Shanghai, China"
